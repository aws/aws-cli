...
from awscli.botocore.docs.method import document_model_driven_method
from awscli.botocore.docs.paginator import document_paginate_method
from awscli.botocore.docs.waiter import document_wait_method
