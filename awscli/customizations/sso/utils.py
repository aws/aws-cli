...
REDIRECT_PORT_ARG = {
    ...
    'help_text': (
        ...
        'when the port must be known in advance, such as when mapping it from '
        'a Docker container to the host. Has no effect when a flow that does '
        'not start a callback server is used.'
    ),
}
