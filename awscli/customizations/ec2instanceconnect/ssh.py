...
from awscli.customizations.exceptions import ConfigurationError, ParamValidationError
...
class SshCommand(BasicCommand):
    ...
    def _validate_parsed_args(self, parsed_args):
        ...
        if self._get_eice_option(eice_options, "dnsName") and not self._get_eice_option(
            eice_options, "endpointId"
        ):
            raise ParamValidationError(
