...
The following ``describe-db-instances`` command describes all DB instances 
...
.. _Describe an Amazon RDS DB Instance: http://docs.aws.amazon.com/cli/latest/userguide/cli-rds-describe-instance.html
