**Update Capacity Provider of ECS cluster**

The following ``update-capacity-provider`` example shows how we can modify the parameters of the capacity provider in ECS cluster. ::
