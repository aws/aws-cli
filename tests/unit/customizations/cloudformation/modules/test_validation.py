...
class TestParameterValidation(unittest.TestCase):
    ...
    def test_validate_string(self):
        ...
        # Valid string
        validate_string("TestModule", "TestParam", 
    ...
    def test_validate_number(self):
        ...
        # Valid number
        validate_number("TestModule", "TestParam", 
    ...
    def test_validate_array(self):
        ...
        # Valid array
        validate_array("TestModule", "TestParam", 
    ...
    def test_validate_object(self):
        ...
        # Valid object
        validate_object("TestModule", "TestParam", 
                       {"Required": ["name"], 
                        "Properties": {
                            "name": {"Type": "String"},
                            "age": {"Type": "Number"}
    ...
    def test_validate_enum(self):
        ...
        # Valid enum value
        validate_parameter("TestModule", "TestParam", 
    ...
    def test_apply_defaults(self):
        ...
        # Override defaults
        result = apply_defaults(schema, {"Name": "CustomName", "Config": {"Count": 10}})
    ...
    def test_nested_validation(self):
        ...
        validate_parameter("TestModule", "Config", schema, {
            "Name": "TestResource",
            "Tags": [
