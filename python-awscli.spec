...
# Deal with python version requirements for RHEL 5 separately
...
LANG=sort -u -o INSTALLED_FILES INSTALLED_FILES
...
%changelog
* Thu Nov  5 2015 Nico Kadel-Garcia <nkadel@gmail.com> - 1.9.5-0.2
- Initial SRPM packaging from python rpm building module
