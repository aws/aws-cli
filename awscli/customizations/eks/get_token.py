...
class GetTokenCommand(BasicCommand):
    ...
    def _run_main(self, parsed_args, parsed_globals):
        ...
        sts_client = client_factory.get_sts_client(
            region_name=parsed_globals.region, role_arn=parsed_args.role_arn, external_id=parsed_args.external_id
        )
...
class STSClientFactory(object):
    ...
    def _get_role_credentials(self, region_name, role_arn, external_id):
        ...
        return sts.assume_role(
            RoleArn=role_arn, RoleSessionName='EKSGetTokenAuth', ExternalId=external_id
        )['Credentials']
