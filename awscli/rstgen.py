...
class OperationDocument(Document):
    ...
    def do_title(self, operation):
        self.add_paragraph().write(self.style.h1(operation.cli_name))
        self.add_paragraph()
    ...
    def build(self):
        self.do_title(self.operation)
        self.do_description(self.operation)
...
class ServiceDocument(Document):
    ...
    def do_title(self, service):
        self.add_paragraph().write(self.style.h1(service.service_full_name))
    ...
    def build(self):
        self.do_title(self.service)
        self.do_name(self.service)
        self.do_description(self.service)
...
class ProviderDocument(Document):
    ...
    def do_toc(self, provider_name):
        ...
        self.add_paragraph().write('.. toctree::')
        self.indent()
        self.add_paragraph().write(':maxdepth: 2')
        self.add_paragraph().write(':titlesonly:')
        self.add_paragraph()
...
def gen_rst(session, provider=None, service=None, operation=None, fp=None):
    """
    """
    if fp is None:
        fp = sys.stdout
