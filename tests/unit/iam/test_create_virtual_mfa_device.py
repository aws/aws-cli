...
class TestCreateVirtualMFADevice(BaseAWSCommandParamsTest):
    ...
    def register_uri(self):
        httpretty.register_uri(httpretty.POST, re.compile('.*'), body=BODY)
