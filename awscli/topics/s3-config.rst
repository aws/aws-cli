...
* ``preferred_transfer_client`` - Determines the underlying Amazon S3 transfer client to use for transferring files to and from S3. For most workloads, 'crt' will enable faster uploads and downloads.
