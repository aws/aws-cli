...
The following ``describe-metadata-model`` example retrieves detailed information about a table in the source metadata tree, including its SQL definition and references to the corresponding converted metadata models in the target database. ::
