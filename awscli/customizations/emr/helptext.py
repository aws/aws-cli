...
LOG_URI = (
    ...
    'will be periodically written. If a value is not provided, '
...
USE_DEFAULT_ROLES = (
    ...
    '<p>Make sure the role and instance profile exist first. To create them,'
...
RELEASE_LABEL = (
    ...
    ' the versions of application software--such as Apache Hadoop,'
    ' Hive, Spark, and so on--that is installed on the cluster.'
    ...
    ' in each Amazon EMR release, see http://docs.aws.amazon.com/emr/ReleaseGuide.'
...
INSTANCE_GROUPS = (
    ...
    ' For more information, see http://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-instance-group-configuration.html.</p>'
    ...
    '<li><code>[EbsConfiguration]</code> - Specifies additional EBS storage volumes attached'
...
INSTANCE_FLEETS = (
    ...
    ' For more information and examples of instance fleet configurations,'
    ' see http://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-instance-fleet.html.</p>'
    ...
    ' use in the instance fleet, including details such as spot price and EBS configuration.</li>')
...
BOOTSTRAP_ACTIONS = (
    ...
    ' either a list of values (for example, <code>Args=arg1,arg2,arg3</code>)'
    ' or a list of key-value pairs, as well as optional values,'
    ' enclosed in square brackets (for example,'
    ' <code>Args=[arg1,arg2=arg2value,arg3])</li>.')

APPLICATIONS = (
    '<p>Specifies the applications to install on the cluster,'
    ' such as Hadoop, Spark, Hue, Hive, Pig, HBase, and so on.'
...
CUSTOM_AMI_ID = (
    ...
    ' AMI can be used to encrypt the EBS root volume. It'
    ' can also be used instead of bootstrap actions to customize'
    ' cluster node configurations. For more information, see'
    ' http://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-custom-ami.html.</p>')
