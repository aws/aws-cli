...
class TestS3SigV4(BaseS3OperationTest):
    ...
    def test_trailing_checksum_set_empty_body(self):
        ...
        body = self.http_stubber.requests[0].body.read()
        self.assertIn(b"x-amz-checksum-crc64nvme:AAAAAAAAAAA=", body)
...
def test_checksums_included_in_expected_operations(
    ...
    with ClientHTTPStubber(client) as stub:
        ...
        assert "x-amz-checksum-crc64nvme" in stub.requests[-1].headers
...
class TestS3XMLPayloadEscape(BaseS3OperationTest):
    def assert_correct_crc64nvme_checksum(self, request):
        checksum = get_checksum_cls()()
        crc64_checksum = checksum.handle(request.body).encode()
        self.assertEqual(
            crc64_checksum, request.headers["x-amz-checksum-crc64nvme"]
        )
    ...
    def test_escape_keys_in_xml_delete_objects(self):
        ...
        self.assertNotIn(b'\r\n\r', request.body)
        self.assertIn(b'&#xD;&#xA;&#xD;', request.body)
        self.assert_correct_crc64nvme_checksum(request)
