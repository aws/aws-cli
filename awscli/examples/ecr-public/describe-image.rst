**Example 1: To describe images in public registry repository**
...
**Example 2: To describe image from the repository by sort imageTags & imagePushedAt.**
...
**Example 3: To describe image from the repository to generate the last 2 image tags pushed in the repositry.**

The following ``describe-images`` example gets imagetags details from the repository named ``project-a/nginx-web-app`` in a public registry and then pipes that output to display only the first two lines. ::
