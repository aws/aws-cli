...
Command::
  ...
  aws ssm deregister-patch-baseline-for-patch-group --region "us-west-2" --patch-group "Production" --baseline-id "arn:aws:ssm:us-west-1:<aws_account_id>:patchbaseline/pb-0ca44a362f8afc725"
