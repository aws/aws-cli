...
def register_count_events(event_handler):
    event_handler.register("building-argument-table.ec2.run-instances", ec2_add_count)
    event_handler.register("before-parameter-build.ec2.RunInstances", set_default_count)
...
class CountArgument(BaseCLIArgument):
    ...
    def add_to_parser(self, parser):
        ...
        parser.add_argument(
            self.cli_name, metavar=self.py_name, help="Number of instances to launch"
        )
