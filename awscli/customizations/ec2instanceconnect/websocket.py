...
class Websocket:
    def __init__(
        ...
        self._send_frame_results_queue = (
            Queue() if (send_frame_results_queue is None) else send_frame_results_queue
        )
...
class WebsocketManager:
    def __init__(
        self, port, max_websocket_connections, eice_request_signer, user_agent=None
    ):
        self._port = port
        self._executor = ThreadPoolExecutor(max_workers=max_websocket_connections)
