...
The following ``update-cluster`` example shows how we can update containerInsights value to enabled to the already created cluster. By default, it is disabled. ::
