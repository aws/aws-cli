...
class TestBatchS3Handler:
    ...
    def setUp(self):
        ...
        self.transfer_manager.__exit__ = mock.Mock()
        self.parameters = {}
        self.batch_s3_handler = BatchS3Handler(
            self.transfer_manager,
            self.parameters,
            self.command_result_recorder,
        )
...
class TestDeleteBatchRequestSubmitter:
    @pytest.fixture(autouse=True)
    def setUp(self):
        ...
        self.bucket = 'mybucket'
        self.key = 'mykey'
        self.delete_batch_submitter = DeleteBatchRequestSubmitter(
