**Example1: To set repository policy to allow a pull on the repository**
...
**Example 2: To set repository policy to allow IAM user within your account to push images**

The following ``set-repository-policy`` allow an IAM user within your account to push images using the cli input file://my-repository-policy.json in your AWS account. ::
...
**Example 3: To set repository policy to allow IAM user from different account to push images**

The following ``set-repository-policy`` example allow a specific account to push images using cli input file://my-repository-policy.json in your AWS account. ::
